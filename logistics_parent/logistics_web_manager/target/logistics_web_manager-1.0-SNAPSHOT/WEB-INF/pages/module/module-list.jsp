    ...
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="/module/delete.do?id="+id;
            }
        }else{
    ...
    <div class="box box-primary">
            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="新建" onclick='location.href="/module/toAdd.do"'><i class="fa fa-file-o"></i> 新建</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="o"  varStatus="st">
                        <tr>
                            ...
                            <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="/module/toUpdate.do?id=${o.id}"'>编辑</button></th>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
        ...
        <div class="box-footer">
            <jsp:include page="../common/page.jsp">
                <jsp:param value="${ctx}/module/list.do" name="pageUrl"/>
            </jsp:include>
        </div>
    </div>
</section>
