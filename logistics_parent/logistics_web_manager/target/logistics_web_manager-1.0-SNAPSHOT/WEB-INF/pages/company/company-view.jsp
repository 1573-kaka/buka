        ...
        <div class="panel panel-default">
            <div class="panel-heading">订单信息</div>
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-2 title">企业管理员</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="企业管理员" name="adminName" value="${company.adminName}">
                    </div>
                    <div class="col-md-2 title">管理员邮箱</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="管理员邮箱" name="adminEmail" value="${company.adminEmail}">
                    </div>
