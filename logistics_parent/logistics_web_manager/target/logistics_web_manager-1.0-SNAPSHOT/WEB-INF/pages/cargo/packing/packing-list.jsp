...
<script>
   /* function view() {
        var id = getCheckId()
        if(id) {
            location.href="/cargo/contract/toView.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }*/
   function view() {
       location.href="${ctx}/cargo/packing/list";
   }
   function sub() {
       /*var id = getCheckId()
       if(id!='') {*/
        ...
        <div class="box box-primary">
                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="查看所有" onclick='view()'><i class="fa  fa-eye-slash"></i> 查看</button>
                                <button type="button" class="btn btn-default" title="装箱" onclick="sub()"><i class="fa fa-refresh"></i> 报运</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                        <form id="packingForm" action="/cargo/packing/toPacking" method="post">
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="${ctx}/cargo/packing/exportlist" name="pageUrl"/>
                </jsp:include>
            </div>
        </div>
    </section>
