                        ...
                        <c:forEach items="${page.list}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>
                                    ...
                                    <c:if test="${o.state==3}"><font color="red">已发票</font></c:if>
                                    <c:if test="${o.state==4}"><font color="red">已财务</font></c:if>
                                ...
                                <td>
                                    ...
                                    <c:if test="${o.state!=0}">
                                        <a href="${ctx}/cargo/packing/packingPdf?id=${o.packingListId}">[下载]</a>
                                    </c:if>
                                </td>
                            </tr>
                        </c:forEach>
