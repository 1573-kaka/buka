...
<script type="text/javascript">
    let goods;
    function  getgood() {
        document.getElementById('factoryName').value=document.getElementById('factoryInfo').options[document.getElementById('factoryInfo').selectedIndex].text;
        let fid=document.getElementById('factoryInfo').options[document.getElementById('factoryInfo').selectedIndex].value;
        $.get('${ctx}/cargo/good/findByfid?fid='+fid).done(function (data) {
                goods = data;
                let select = document.getElementById('productNo');
    ...
    function getPrice() {
        let g=document.getElementById("productNo").options[document.getElementById("productNo").selectedIndex].value;
        for(let good of goods){
            if(g==good.id){
                document.getElementById("price").value=good.price;
                document.getElementById("productDesc").value=good.describes;
            }
        }
    }
</script>
