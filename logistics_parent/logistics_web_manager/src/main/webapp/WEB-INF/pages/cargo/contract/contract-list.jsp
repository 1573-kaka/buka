                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td><c:if test="${o.state==0}">草稿</c:if>
                                <c:if test="${o.state==1}"><font color="purple">已下单</font></c:if>
                                <c:if test="${o.state==2}"><font color="brown">已审核</font></c:if>
                                <c:if test="${o.state==3}"><font color="pink">已装箱</font></c:if>
                                <c:if test="${o.state==4}"><font color="gold">已出库</font></c:if>
                               <%-- <c:if test="${o.state==5}"><font color="blue">已装箱</font></c:if>
                                <c:if test="${o.state==6}"><font color="green">已出库</font></c:if>
                                <c:if test="${o.state==7}"><font color="red">已到达</font></c:if>--%>
                            </td>
                            <td>
