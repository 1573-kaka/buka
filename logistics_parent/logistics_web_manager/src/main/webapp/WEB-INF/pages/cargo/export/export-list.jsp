                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="电子报备" onclick="exportE()"><i class="fa fa-refresh"></i> 电子报运</button>
                        </div>
                    </div>
                </div>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                            ...
                            <td>
                                ...
                                <c:if test="${o.state==2}"><font color="red">已出库</font></c:if>
                                <%--<c:if test="${o.state==3}"><font color="yellow">已装箱</font></c:if>--%>
                            </td>
                            <td>
