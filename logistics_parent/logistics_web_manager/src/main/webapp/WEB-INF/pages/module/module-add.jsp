    ...
    <div id="frameContent" class="content-wrapper" style="margin-left:0px;">
        ...
        <section class="content">
            <div class="panel panel-default">
                ...
                <form id="editForm" action="/module/edit.do" method="post">
                    ...
                    <div class="row data-type" style="margin: 0px">
                        ...
                        <div class="col-md-4 data">
                            <div class="form-group form-inline">
                                ...
                                <div class="radio"><label><input type="radio" ${module.ctype==2?'checked':'checked'} name="ctype" value="2">按钮</label></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="form-group form-inline">
                                <div class="radio"><label><input type="radio" ${module.state==0?'checked':'checked'} name="state" value="0">停用</label></div>
                        ...
                        <div class="col-md-4 data">
                            ...
                            <div class="radio"><label><input type="radio" ${module.belong==1?'checked':'checked'} name="belong" value="1">租用企业菜单</label></div>
                            </div>
                        </div>
