                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${user.state==0?'checked':'checked'} name="state" value="0">停用</label></div>
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            ...
                            <div class="radio"><label><input type="radio" ${user.degree==2?'checked':''} name="degree" value="2">下属部门和人员</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==3?'checked':''} name="degree" value="3">管理本部门</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==4?'checked':'checked'} name="degree" value="4">普通员工</label></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${user.gender==0?'checked':'checked'} name="gender" value="0">男</label></div>
